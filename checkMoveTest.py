...
# if prof!="":
# 	print "Proffessor is unavailable because of",prof.cc,prof.cn
# else:
# 	print "Proffessor is available at this time"

if conflicts==[]:
	sys.stdout.write("There are no conflicts!")
else:
	studString=''
	g=0
	for i in conflicts:
		if(conflicts[g] is not None):
			studString=studString+i.fn+' '+i.ln+' '+str(i.b)+' '+i.e+' '+i.c+' '+i.cc+' '+i.cn+' '
		else:
			studString=studString+i.fn+' '+i.ln+' '+str(i.b)+' '+i.e+' '+i.c+' '+i.cc+' '+i.cn
		g=g+1
	sys.stdout.write(studString+'endl')
