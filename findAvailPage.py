...
if (form.getvalue("course", "") == ""):
	print ''.join([
		"<form method='post' action='findAvailPage.py'>Course:<input type='text' name='course'/><br/>",
		"Acceptable Losses (SR):<input type='number' name='SR'/><br/>Acceptable Losses (!SR):<input type='number' name='NSR'/><br/>",
...
"t1.`Monday Ind1`, t1.`Tuesday Ind1`, t1.`Wednesday Ind1`, t1.`Thursday Ind1`, t1.`Friday Ind1`, t1.`Saturday Ind1`, t1.`Sunday Ind1` ",
"having sum(t2.`Class Code` = 'SR') > ",form.getvalue("SR")," or sum(t2.`Class Code` != 'SR') > ",form.getvalue("NSR"),") ",
